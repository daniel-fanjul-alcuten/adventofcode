...
var P1 = []string{
	...
	"ewlzxp (284)",
	"iysts (35) -> xiqdw, ecxsy, kikilp, ozsipa",
	"vumoui (25)",
	...
	"qjcjey (93)",
	"raopje (31)",
	"gtbbe (466) -> jxfhkc, cugcfjb, ltyj, vqhncp, xbmjza, uekierg, xwsxb",
	...
	"aenhbm (278)",
	"jturbxp (50)",
	"iewhsnf (81) -> gilke, ohedu, zaskzam, dzino, ockea, seddq, hzggfe",
	"gyprs (29)",
	...
	"oowsfeci (227) -> juogz, sqzyu, pxyfbvy, csbxo, sbpdtfq",
	"ogljepx (8)",
	"ssufgph (237) -> vxgadew, ijssypy",
	"ikkvmpl (21)",
	"ohyndb (98)",
	"eoqzo (51)",
	"krodu (33)",
	...
	"otrpt (59)",
	"yhqov (1441) -> xzhdixq, rxctq, araqifq",
	...
	"fjuytze (90) -> ucapgv, riaadk, szczoglq",
	"jrwycer (31)",
	...
	"tibijki (73) -> zuevpk, josri",
	"hozmnv (75)",
	"wgetx (165) -> entity, cqkxj",
	"ybauin (97)",
	...
	"utlqx (13165) -> dyfcem, andubrz, okuup, jhfos",
	"wuglbn (30)",
	...
	"rbcqg (23)",
	"pvuyft (66)",
	"sdjzoik (1184) -> cnmtugy, saome, cjkhs, vwobzsl, vsrrw",
	"wzpfe (16)",
	"cqkxj (34)",
	...
	"qvqwp (73)",
	"maajj (63)",
	"xnuirq (92) -> oozsasi, ojctrz, xaacva",
	"emuzuk (90)",
	"iraqghm (89)",
	"hsifio (75)",
	"mgxbrrh (58)",
	...
	"zoyfhq (6)",
	"gtcmb (94)",
	"jzczzhm (173) -> intervening, wtjxdv, thvlvgt",
	"nffqvwl (32)",
	"qoyyyzt (91)",
	"ktmepg (9)",
	"qyptue (82)",
	...
	"rnsmk (40)",
	"pvxboe (43)",
	"ifdqaup (5829) -> oowsfeci, ruxkyn, kcelbg, tnbuu, ydkppqv",
