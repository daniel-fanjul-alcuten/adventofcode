...
func TestP1(t *testing.T) {
	if r := P1(1, parse(S1)); r != 31 {
		t.Error(r)
	}
	if r := P1(1, parse(S2)); r != 165 {
		t.Error(r)
	}
	if r := P1(1, parse(S3)); r != 13312 {
		t.Error(r)
	}
	if r := P1(1, parse(S4)); r != 180697 {
		t.Error(r)
	}
	if r := P1(1, parse(S5)); r != 2210736 {
		t.Error(r)
	}
	if r := P1(1, parse(X)); r != 301997 {
		t.Error(r)
	}
}

func TestP2(t *testing.T) {
	if r := P2(parse(S3)); r != 82892753 {
		t.Error(r)
	}
	if r := P2(parse(S4)); r != 5586022 {
		t.Error(r)
	}
	if r := P2(parse(S5)); r != 460664 {
		t.Error(r)
	}
	if r := P2(parse(X)); r != 6216589 {
		t.Error(r)
	}
}
